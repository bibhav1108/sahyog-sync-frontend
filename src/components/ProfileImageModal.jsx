    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
            ...
            <motion.div 
                ...
                className="bg-surface_lowest w-full max-w-xl rounded-[2.5rem] overflow-hidden shadow-2xl border border-white relative"
            >
                        ...
                        >
                            <div className="flex justify-between items-center mb-10">
                                <div>
                                    ...
                                    <p className="text-xs text-on_surface_variant uppercase font-black tracking-widest opacity-50">Identity Management</p>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                <button 
                                    ...
                                    className={`flex flex-col items-center justify-center p-8 rounded-3xl border-2 transition-all group
                                        ${!currentImage 
                                            ...
                                            : "border-error/10 bg-error/5 hover:border-error/30 hover:bg-error/10"}`}
                                >
                                ...
                                <button 
                                    ...
                                    className="flex flex-col items-center justify-center p-8 rounded-3xl border-2 border-primary/10 bg-primary/5 hover:border-primary/30 hover:bg-primary/10 transition-all group"
                                >
                            ...
                            <button 
                                onClick={onCancel}
                                className="w-full mt-10 py-4 text-xs font-black uppercase tracking-[0.2em] text-on_surface_variant hover:text-on_surface transition-colors"
                            >
                                Stay as is
                            </button>
                        </motion.div>
